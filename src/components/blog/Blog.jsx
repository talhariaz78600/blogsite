    ...
    return (
        <div>
            <main id="MainContent" className="content-for-layout focus-none" role="main" tabIndex="-1">
                ...
                <section id="shopify-section-template--14480007594029__main" className="shopify-section spaced-section">
                    <div className="main-blog page-width">
                        <h1 className="title--primary">{title}</h1>
                        <div className="blog-articles ">
                            {data.data.map((item, index) => {
                                return <div key={index} className="blog-articles__article article">

                                    <article className="article-card" aria-labelledby="Article-558988197933">
                                        <Link href={`/category/${title}/detail/${item._id}?pageno=${pageno}`} className="article-content motion-reduce"><div className="article-card__image-wrapper">
                        ...
                        <div className="pagination-wrapper">
                            ...
                            {data.search === "no" && <FooterPagination stoped={data.total} pagelength={10} pageno={pageno} pagename={title} />}
                        </div></div>
                </section>
