  ...
  return (
    <div>
      ...
      <section id="shopify-section-template--14480007462957__main" className="shopify-section">
        <article className="article-template" itemScope>
          ...
          <div className="element-margin center">
            <Link href={`/category/${data.category}/${pageno}`} className="article-template__link link animate-arrow">
